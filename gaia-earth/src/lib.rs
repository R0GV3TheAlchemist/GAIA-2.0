//! Artificial Twin of Earth (#33–#40).
//! Observation contract, commons catalog, and ingest charter checks.
//! Not Iceberg, Cesium, GraphCast weights, a live GCM, or a legal opinion.
