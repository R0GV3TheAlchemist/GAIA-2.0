...
pub fn live_containerd() -> bool { false }
pub fn live_mcp() -> bool { false }
pub fn live_slurm() -> bool { false }
pub fn live_whisper() -> bool { false }
...
pub fn hal_tiers() -> [HalTier; 5] {
    [HalTier::T0, HalTier::T1, HalTier::T2, HalTier::T3, HalTier::T4]
}
