...
pub fn rsi() -> bool { false }
pub fn sentience() -> bool { false }
pub fn five_nines_claimed() -> bool { false }

#[derive(Debug, Clone, PartialEq, Eq)]
pub enum SosError { Unsigned, NoCapability, WeightRewrite, GodCoordinator }
