...
**Closes issues:** #961
**C77 gate:** no canon without proof
...
4. **Epistemic dependency.** The doctrine cites issue #953 (epistemic state layer) as a capability safety primitive: a system that cannot distinguish uncertain from contradicted cannot be trusted at Band 3. This links the two documents into a coherent safety chain.

## Proof of correctness

- No tripwire may be resolved by GAIA itself — verified: the mandatory pause protocol step 5 (`decide`) is explicitly assigned to human reviewers.
