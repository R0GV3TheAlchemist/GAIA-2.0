...
| Embodied grounding | embodiment | 3 | fixture stub only |
...
- Issues: #168 (epic), #519 (this listed slice)
- Next: `PHASE-2.md` (#521, closed) — grounding interface
